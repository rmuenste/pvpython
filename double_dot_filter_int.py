...
gradientOfUnstructuredDataSet1.ScalarArray = ['POINTS', 'BigU']
...
xx = (-mix + 1) * inputs[0].PointData["dudx"]
yy = (-mix + 1) * inputs[0].PointData["dvdy"]
zz = (-mix + 1) * inputs[0].PointData["dwdz"]
xy = (-mix + 1) * (inputs[0].PointData["dudy"] + inputs[0].PointData["dvdx"]) * 0.5
yz = (-mix + 1) * (inputs[0].PointData["dvdz"] + inputs[0].PointData["dwdy"]) * 0.5
xz = (-mix + 1) * (inputs[0].PointData["dudz"] + inputs[0].PointData["dwdx"]) * 0.5
